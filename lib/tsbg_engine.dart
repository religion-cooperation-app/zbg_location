    ...
    try {
      await fbg.BackgroundGeolocation.ready(
        fbg.Config(
          ...
          // Collect locations only between 05:00–00:00 (midnight) every day.
          // startSchedule() activates this; during the off-window FBG stops automatically.
          schedule: ['1-7 05:00-00:00'],
          scheduleUseAlarmManager: Platform.isAndroid, // precise wake on Android
  ...
  Future<void> start() async {
    ...
    try {
      if (_cfg?.geofenceOnlyMode == true) {
        ...
        // startSchedule() activates the 05:00-00:00 window config.
        // FBG automatically starts/stops tracking based on the schedule.
