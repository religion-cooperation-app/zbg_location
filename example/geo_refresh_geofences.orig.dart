...
Future<String> geoRefreshGeofences(String? regionId) async {
  ...
  // PRE-CHANGE-H original — early-return when GeoBootstrap not running.
  // Removed in batch 3+6 commit; refreshGeofencesFromFirestore now has its own
  // fallback path when !isRunning. Block below is approximate reconstruction.
  if (!GeoBootstrap.instance.isRunning) {
